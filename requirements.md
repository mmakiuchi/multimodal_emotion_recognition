You will need to install some python packages and to get the scripts of the Gentle aligner
that are available in their repository.
You should also check the dependencies to run the Gentle aligner
(Please refer to the repository https://github.com/lowerquality/gentle for more information),
